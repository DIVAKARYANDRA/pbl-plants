  ...
  return (
    ...
    <div>
      ...
      <PageHeader
        ...
        subtitle="Generate Quotation for PBL customers."
      />
...
>
  ...
  onClick={async () => {
    ...
    try {
      ...
      if (!validTill) {
        alert("Please select quotation validity date.");
        return;
      }
      ...
      const quotationNo =
        `QT-${date}-${String(Date.now()).slice(-4)}`;
      ...
      alert(`Quotation ${quotationNo} saved successfully.`);
